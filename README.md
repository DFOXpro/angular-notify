...
* `duration` - Optional.  The duration (in milliseconds) of message.  A duration less than 0 will prevent messages from closing automatically, note that 0 duration is replace as default duration (10000ms or 10sec).
